...
# Define a list of domain-specific keywords (as phrases for better matching)
domain_specific_keywords = [
    ...
    "Peer Dependency Warning", "template","Build Failure", "Performance Bottleneck", "High CPU Usage", "High Memory Usage", 
...
def extract_keywords_with_spacy(text, top_n=20):
...
print(extract_keywords_with_spacy("""The template alignment problem is one of the central problems which currently remains unsolved for a general OMR sheet. This issue tracks various issues that we have noticed over a period of time in various samples.
